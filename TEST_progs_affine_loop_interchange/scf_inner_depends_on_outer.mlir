  ...
  func.func @triangular(%arg0: memref<?x100xi32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.for %arg1 = %c0 to %c100 step %c1 {
      ...
      scf.for %arg2 = %c0 to %arg1 step %c1 {
        ...
        memref.store %2, %arg0[%arg1, %arg2] : memref<?x100xi32>
      }
    }
    return
  }
